 ...
 * @author Jun Ming
 */
public class buildingManagerEmployeeEditFrame extends javax.swing.JFrame {

    /**
     * Creates new form buildingManagerEmployeeEditFrame
     */
    public buildingManagerEmployeeEditFrame() {
        initComponents();
    }
    ...
    private void backBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backBtnActionPerformed
        ...
        employeeManage.setUserType(userType);
        employeeManage.setEmployeeTeamData(userType);
        ...
        if(addEditDetector=="edit"){
            if((employeeNameField.getText()).equals("") ||(employeeAgeField.getText()).equals("") ||(employeePhoneNumberField.getText()).equals("") || (credentialNameField.getText()).equals("") || (credentialPasswordField.getPassword()).equals("") || this.imageName==null) {
                ...
                if (sourceFile!=null) {
                    ...
                    buildingManagerMain.transferImage(source,dest);
                }
            }
        }
    ...
    private void imageUploaderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_imageUploaderActionPerformed
        ...
        try{
            ...
            buildingManager buildingManagerMain = new buildingManager();
            filechooser.addChoosableFileFilter(buildingManagerMain.new ImageFilter());
    ...
    public void addEditDetect(String functionType,String id) {
        if(functionType=="edit"){
            ...
            employeeClass.getDataViewSingle(id, fileType,"Employee");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buildingManagerEmployeeEditFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buildingManagerEmployeeEditFrame().setVisible(true);
            }
        });
    }

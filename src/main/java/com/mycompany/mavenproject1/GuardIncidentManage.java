 ...
 * @author user
 */
public class GuardIncidentManage extends javax.swing.JFrame {

    ArrayList<String> dataList;
    
    public GuardIncidentManage() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GuardIncidentManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GuardIncidentManage().setVisible(true);
            }
        });
    }
    ...
    private void displayDataView(Integer pageLine, String part)
    {
        try{
            GuardMain main = new GuardMain();
            String incidentFile = "src/main/java/com/mycompany/textFile/Incident.txt";
            ArrayList<ArrayList<String>> userData = onlyUserDataInfo(incidentFile);
            ...
            try{
                ...
                if(part.equals("upper"))
                {
                    ...
                    detailTxt1.setText(userData.get(pageLine).get(2));
                    ...
                    detailTxt2.setText(userData.get(pageLine).get(2));
            ...
            Logger.getLogger(GuardIncidentManage.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private ArrayList<ArrayList<String>> onlyUserDataInfo(String textFile) throws FileNotFoundException 
    {
        ...
        {
            if(allUserInfo.get(p).contains(guardId))
            {
                ArrayList<String> item = allUserInfo.get(p);
                if(item.get(1).equals(guardId))
                {

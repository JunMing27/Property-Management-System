 ...
 * @author user
 */
public class VendorPaymentOption extends javax.swing.JFrame {

    /**
     * Creates new form VendorPaymentOption
     */
    public VendorPaymentOption() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorPaymentOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorPaymentOption().setVisible(true);
            }
        });
    }

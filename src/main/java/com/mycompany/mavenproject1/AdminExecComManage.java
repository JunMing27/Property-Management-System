 ...
 * @author Jun Ming
 */
public class AdminExecComManage extends javax.swing.JFrame {

    /**
     * Creates new form AdminExecComManage
     */
    public AdminExecComManage() {
        initComponents();
    }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(!(jLabel4.getText()).equals("no data")){
            ...
            try {
                comAddEdit.addEditDetect("edit",jLabel4.getText());
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(!(jLabel16.getText()).equals("no data")){
            ...
            comAddEdit.setVisible(true);
            try {
                comAddEdit.addEditDetect("edit",jLabel16.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(BusManBudgetPlanningView.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    public void setComplaintData(){
        ...
        main.chooseTxtFile("Complaint");
            ...
            if(main.getComplaintId() !=null ){
                jLabel4.setText(main.getComplaintId());
                jLabel5.setText(main.getComplaintDetail());
                jLabel6.setText(main.getComplaintReply());
            }else{
            ...
            if(main.getComplaintId() !=null ){
                jLabel10.setText(main.getComplaintId());
                jLabel11.setText(main.getComplaintDetail());
                jLabel12.setText(main.getComplaintReply());
            }else{
            ...
            if(main.getComplaintId() !=null ){
                jLabel16.setText(main.getComplaintId());
                jLabel17.setText(main.getComplaintDetail());
                jLabel18.setText(main.getComplaintReply());
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecComManage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecComManage().setVisible(true);
            }
        });
    }

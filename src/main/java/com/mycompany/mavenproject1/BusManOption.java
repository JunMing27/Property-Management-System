 ...
 * @author Jun Ming
 */
public class BusManOption extends javax.swing.JFrame {

    /**
     * Creates new form BusinessManagerOption
     */
    public BusManOption() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton3.setText("Generate and View Report");
        ...
        jButton4.setText("Project and Maintenance");
        ...
        jButton5.setText("Team Structure");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BusManOption.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BusManOption().setVisible(true);
            }
        });
    }

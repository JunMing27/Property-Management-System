...
public class AdminExecUnitManage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Unit Availability");
        ...
        jLabel8.setText("Unit Availability");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(0, 0, 0));
        jLabel9.setText("Unit ID");
        ...
        jLabel14.setText("Unit Availability");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("Unit ID");
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(!(jLabel4.getText()).equals("no data")){
            this.dispose();
            AdminExecUnitAddEdit unitAddEdit = new AdminExecUnitAddEdit();
            ...
            try {
                unitAddEdit.addEditDetect("edit",jLabel4.getText());
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        if(!(jLabel10.getText()).equals("no data")){
            this.dispose();
            AdminExecUnitAddEdit userAddEdit = new AdminExecUnitAddEdit();
            ...
            try {
                userAddEdit.addEditDetect("edit",jLabel10.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(BusManBudgetPlanningView.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        if(!(jLabel16.getText()).equals("no data")){
            ...
            userAddEdit.setVisible(true);
            try {
                userAddEdit.addEditDetect("edit",jLabel16.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(BusManBudgetPlanningView.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        ...
        main.chooseTxtFile("Unit Management");
        setUnitData();
    ...
    public void setUnitData(){
        ...
        main.chooseTxtFile("Unit Management");
            try {
                setPagination();
                main.displayDataView(PageLine,searchTxt,"unit");
            ...
            if(main.getUnitId() !=null ){
                jLabel4.setText(main.getUnitId());
                jLabel5.setText(main.getUnitNo());
                jLabel6.setText(main.getUnitAvail());
            }else{
            ...
            if(main.getUnitId() !=null ){
                jLabel10.setText(main.getUnitId());
                jLabel11.setText(main.getUnitNo());
                jLabel12.setText(main.getUnitAvail());
            }else{
            ...
            if(main.getUnitId() !=null ){
                jLabel16.setText(main.getUnitId());
                jLabel17.setText(main.getUnitNo());
                jLabel18.setText(main.getUnitAvail());
            }else{

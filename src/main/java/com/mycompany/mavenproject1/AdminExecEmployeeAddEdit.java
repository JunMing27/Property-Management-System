...
public class AdminExecEmployeeAddEdit extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(addEditDetector=="edit"){
            ...
            if((jTextField2.getText()).equals("") ||(jTextField4.getText()).equals("") ||(jTextField5.getText()).equals("") || (jTextField6.getText()).equals("") || (jTextField7.getText()).equals("") || (jPasswordField1.getPassword()).equals("")|| this.imageName==null) {
                ...
                AdminExecutiveMain main = new AdminExecutiveMain();
                ArrayList<String> dataList = new ArrayList<String>();
                main.getIncreasedID("Employee.txt","employee");
                ...
                main.editOrAddData(dataList, "employee","Employee.txt","add");
                //transfer uploaded image to our system image folder 
                try {
                    File dest = new File("src/main/java/com/mycompany/image/" + this.imageName);
                    File source = sourceFile;
    ...
    public void addEditDetect(String functionType,String id) throws FileNotFoundException{
        if(functionType=="edit"){
            ...
            AdminExecutiveMain main = new AdminExecutiveMain();
            main.getDataViewSingle(id, "Employee.txt","employee");
            jButton2.setText("Update");
            jTextField1.setText(main.getEmployeeId());
            jTextField2.setText(main.getEmployeeName());
            if(main.getEmployeeGender().equals("male")){
                jCheckBox1.setSelected(true);
            }else if(main.getEmployeeGender().equals("female")){
                jCheckBox2.setSelected(true);
            }
            jTextField4.setText(main.getEmployeeAge());
            jTextField5.setText(main.getEmployeeContact());
            jTextField6.setText(main.getEmployeeJob());
            this.imageName=main.getEmployeeImage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecEmployeeAddEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run(){
                new AdminExecEmployeeAddEdit().setVisible(true);
            }
        });
    }

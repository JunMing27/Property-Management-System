 ...
 * @author Jun Ming
 */
public class AdminExecVendorAddEdit extends javax.swing.JFrame {

    /**
     * Creates new form AdminExecVendorAddEdit
     */
    public AdminExecVendorAddEdit() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(addEditDetector=="edit"){
            if((jTextField2.getText()).equals("") ||(jTextField4.getText()).equals("") ||(jTextField5.getText()).equals("") || (jTextField7.getText()).equals("") || (jPasswordField1.getPassword()).equals("") || this.imageName==null) {
                ...
                main.editOrAddData(dataList, "vendor","VendorProfile.txt","edit");
            ...
            if((jTextField2.getText()).equals("") ||(jTextField4.getText()).equals("") ||(jTextField5.getText()).equals("") || (jTextField7.getText()).equals("") || (jPasswordField1.getPassword()).equals("")|| this.imageName==null) {
                ...
                AdminExecutiveMain main = new AdminExecutiveMain();
                ArrayList<String> dataList = new ArrayList<String>();
                main.getIncreasedID("VendorProfile.txt","vendor");
                dataList.add(main.getVendorId());
                dataList.add(jTextField2.getText());
                if(jCheckBox1.isSelected()){
                    dataList.add("male");
                }else{
                ...
                main.editOrAddData(dataList, "vendor","VendorProfile.txt","add");
                //transfer uploaded image to our system image folder
                try {
                    if(sourceFile!=null){
                        File dest = new File("src/main/java/com/mycompany/image/" + this.imageName);
    ...
    public void addEditDetect(String functionType,String id) throws FileNotFoundException{
        if(functionType=="edit"){
            ...
            AdminExecutiveMain main = new AdminExecutiveMain();
            main.getDataViewSingle(id, "VendorProfile.txt","vendor");
            jButton2.setText("Update");
            jTextField1.setText(main.getVendorId());
            jTextField2.setText(main.getVendorName());
            if(main.getVendorGender().equals("male")){
                jCheckBox1.setSelected(true);
            }else if(main.getVendorGender().equals("female")){
                jCheckBox2.setSelected(true);
            }
            jTextField4.setText(main.getVendorAge());
            jTextField5.setText(main.getVendorContact());
            this.imageName=main.getVendorImage();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminExecVendorAddEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminExecVendorAddEdit().setVisible(true);
            }
        });
    }

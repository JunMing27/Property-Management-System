...
public class VendorPending extends javax.swing.JFrame {

    VendorMain main;
    String id;
    
    public VendorPending() {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendorPending.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VendorPending().setVisible(true);
            }
        });
    }
    ...
    private void displayDataView(Integer pageLine, String part)
    {
        try{
            ...
            Logger.getLogger(VendorPending.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

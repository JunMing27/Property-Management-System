...
public class BuildingExecComplaintManage extends javax.swing.JFrame {
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        deleteComplaintIDbel4.getText());
    }//GEN-LAST:event_DeleteActionPerformed

    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
        // TODO add your handling code here:
        iComplaintIDbel4.getText()).equals("no data")){
            this.dispose();
            ...
            try {
                comAddEdit.addEditDetect("edComplaintIDbel4.getText());
    ...
    private void Update1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Update1ActionPerformed
        ...
        if(!(jLabel10.getText()).equals("no data")){
            ...
            comAddEdit.setVisible(true);
            try {
                comAddEdit.addEditDetect("edit",jLabel10.getText());
            } catch (FileNotFoundException ex) {
                Logger.getLogger(BusManBudgetPlanningView.class.getName()).log(Level.SEVERE, null, ex);
            }
        }else{

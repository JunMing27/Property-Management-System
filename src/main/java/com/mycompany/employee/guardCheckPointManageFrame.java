 ...
 * @author user
 */
public class guardCheckPointManageFrame extends javax.swing.JFrame {

    static String idGet;
    
    public guardCheckPointManageFrame(String id) {
        initComponents();
        setResizable(false);
    ...
    private void viewBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtn1ActionPerformed
        this.dispose();
        guardCheckPointViewFrame view = new guardCheckPointViewFrame(idGet, "A");
    ...
    private void viewBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtn3ActionPerformed
        this.dispose();
        guardCheckPointViewFrame view = new guardCheckPointViewFrame(idGet,"C");
        view.setVisible(true);
    ...
    private void viewBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtn2ActionPerformed
        this.dispose();
        guardCheckPointViewFrame view = new guardCheckPointViewFrame(idGet,"B");
        view.setVisible(true);
    ...
    private void viewBtn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewBtn4ActionPerformed
        this.dispose();
        guardCheckPointViewFrame view = new guardCheckPointViewFrame(idGet,"D");
        view.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(guardCheckPointManageFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new guardCheckPointManageFrame().setVisible(true);
            }
        });
    }

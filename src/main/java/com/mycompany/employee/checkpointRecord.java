 ...
 * @author hoiyi
 */
public class checkpointRecord implements displayController1{
    
    //for checkpointRecord record
    ...
    public ArrayList<ArrayList<String>> onlyUserDataInfo(String textFile) {
        ...
        if (file.exists()) {
            ...
            try {
                ...
                Logger.getLogger(checkpointRecord.class.getName()).log(Level.SEVERE, null, ex);
            }
            String oneUserInfo; 
            String[] itemArray;

 ...
 * @author hoiyi
 */
public class vendorPaymentMenuFrame extends javax.swing.JFrame {

    static String idGet;
    
    public vendorPaymentMenuFrame(String id) {
        initComponents();
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vendorPaymentMenuFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);

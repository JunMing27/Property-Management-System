 ...
 * @author user
 */
public class buildingExecComplaintManageFrame extends javax.swing.JFrame {

    /**
     * Creates new form buildingExecComplaintManage
     */
    public buildingExecComplaintManageFrame() {
        initComponents();
    }
    ...
    private void viewDetailBtn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailBtn1ActionPerformed
        ...
        if(!(ComplaintIdLabel1.getText()).equals("no data")){
            this.dispose();
            buildingExecComplaintEdit comEdit = new buildingExecComplaintEdit();
            comEdit.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
            comEdit.pack();
            comEdit.setResizable(false);
            comEdit.setLocationRelativeTo(null);
            comEdit.setVisible(true);
            try {
                comEdit.addEditDetect("edit",ComplaintIdLabel1.getText());
    ...
    private void viewDetailBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailBtn2ActionPerformed
        ...
        if(!(ComplaintIdLabel2.getText()).equals("no data")){
            ...
            comEdit.setVisible(true);
            try {
                comEdit.addEditDetect("edit",ComplaintIdLabel2.getText());
            } catch (FileNotFoundException ex) {
            }
        }else{
            JOptionPane.showMessageDialog(null, "This is an empty data", "Warning", JOptionPane.ERROR_MESSAGE);
    ...
    private void viewDetailBtn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewDetailBtn3ActionPerformed
        ...
        if(!(ComplaintIdLabel3.getText()).equals("no data")){
            ...
            comEdit.setVisible(true);
            try {
                comEdit.addEditDetect("edit",ComplaintIdLabel3.getText());
            } catch (FileNotFoundException ex) {
            }
        }else{
            JOptionPane.showMessageDialog(null, "This is an empty data", "Warning", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(buildingExecComplaintManageFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new buildingExecComplaintManageFrame().setVisible(true);
            }
        });
    }
